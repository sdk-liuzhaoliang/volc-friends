...
export default function HomePage() {
    ...
    return (
      <Container maxWidth="sm" sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative', pb: 8 }}>
        <Box display="flex" alignItems="center" mb={3}>
          <img src="/logo.png?v=2" alt="VolcFriends Logo" style={{ width: 52, height: 52, marginRight: 14, borderRadius: 11, background: '#fff' }} />
  ...
  return (
    <Container maxWidth="sm" sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative', pb: 8 }}>
      <Box display="flex" alignItems="center" mb={3}>
        <img src="/logo.png?v=2" alt="VolcFriends Logo" style={{ width: 65, height: 65, marginRight: 18, borderRadius: 11, background: '#fff' }} />
